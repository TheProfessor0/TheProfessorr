#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To TheProfessor
...
\033[1;92m..........................TheProfessor......................
                                    The Professor

\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mThe Professor\033[1;95m♡╰──────────•◈•──────────╯♡"""
...
██║░░░░░██║░░██║╚█████╔╝██║░░░░░███████╗██████╔╝██████╔╝╚█████╔╝██║░░██║
╚═╝░░░░░╚═╝░░╚═╝░╚════╝░╚═╝░░░░░╚══════╝╚═════╝░╚═════╝░░╚════╝░╚═╝░░╚═╝
   \033[1;92m███████▒▒BaXeR BeIT Bo The Professor Proces▒▒████████
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96mTheProfessor\033[1;95m♡╭──────────•◈•──────────╮♡
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):The
        ...
        if (password == CorrectPassword):Professor
            print "Logged in successfully as " + username #Dev:The_Professor
	    time.sleep(2)
            loop = 'false'
        else:
...
def login():
	...
	try:
		...
		os.system('clear')
		print logo
		jalan(' \033[1;92mWarning: \033[1;97mDo AccounTY ShaXsy XoT BaKaR MaHeNa' )
		jalan(' \033[1;92m   Note: \033[1;97mAccounteky TaZa BaKaR BeNa' )
		print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mTheProfessor\033[1;95m♡──────────•◈•──────────♡"
		print('	   \033[1;94m♡\x1b[1;91m》》》》》》LOGIN BA BA FACEBOOK《《《《《《\x1b[1;94m♡' )
		print('	' )
		...
		if 'checkpoint' in url:
			print("\n\x1b[1;92mAccountakaT CHEK POINTA")
...
def menu():
	...
	print "\033[1;95m♡─────────•◈•─────────♡\033[1;96mTheProfessor\033[1;95m♡─────────•◈•─────────♡"
	print "\033[1;97m--\033[1;92m> \033[1;92m1.\x1b[1;92mCloNaKa DaST Pe AKA..."
...
def pilih_super():
	peak = raw_input("\n\033[1;an Optio97mDANAYAKIAN HALL BZHERA>>> \033[1;97m")
	if peak =="":
		print "\x1b[1;91mFill in correctly"
		pilih_super()
	elif peak =="1":
	...
	p.map(main, id)
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mTheProfessor\033[1;95m♡──────────•◈•──────────♡"
	print "  \033[1;93m«---•◈•---Developed By Professor---•◈•---»" #Dev:The_Professor
